...
$(document).ready(function() {
	...
	$(".teclab").mousedown(function () {
	  	toneId = $(this).attr('id');
			play_multi_sound('tone-'+toneId);
	 });

	$(".teclab").mouseup(function () {
	  	toneId = $(this).attr('id');
			//stop_multi_sound('tone-'+toneId, 'mouse');
	 });
 	
	$(".teclan").mousedown(function () {
	  	toneId = $(this).attr('id');
			play_multi_sound('tone-'+toneId);
	 });

	$(".teclan").mouseup(function () {
	  	toneId = $(this).attr('id');
			stop_multi_sound('tone-'+toneId, 'mouse');
	 });
...
/*
$.scrollTo($('a#middleC'));
Uncaught TypeError: Object function (a,b){return new d.fn.init(a,b,g)} has no method 'scrollTo'
	 */